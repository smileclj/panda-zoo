...
public class NetUtil {
    ...
    public static String securePostByNoAuth(String url, String params, String encoding, int connectionTimeout, int readTimeout) {
        String result = "";
        BufferedReader in = null;
        PrintWriter out = null;
        try {
    ...
    public static String securePostByNoAuth(String url, String params) {
        return securePostByNoAuth(url, params, DEFAULT_ENCODE, DEFAULT_CONNECTION_TIMEOUT, DEFAULT_READ_TIMEOUT);
    }

    public static String securePostByAuth(String url, String params, String encoding, int connectionTimeout, int readTimeout) {
        String result = "";
        BufferedReader in = null;
        PrintWriter out = null;
        InputStream is = null;
    ...
    public static String securePostByAuth(String url, String params) {
        return securePostByAuth(url, params, DEFAULT_ENCODE, DEFAULT_CONNECTION_TIMEOUT, DEFAULT_READ_TIMEOUT);
    }
            ...
            if (files != null) {
                for (Map.Entry<String, File> entry : files.entrySet()) {
                    if (entry.getValue() == null) {
                        ...
                        StringBuilder sb = new StringBuilder();
                        // MagicMatch match = new
                        // Magic().getMagicMatch(entry.getValue(), false,true);
                        sb.append("\r\n").append("--").append(BOUNDARY).append("\r\n");
    ...
    public static void main(String[] args) {
        String commonUrl = "http://www.baidu.com";
        // System.out.println(NetUtils.get(commonUrl,"id=小明"));
         System.out.println(NetUtil.post(commonUrl,""));
