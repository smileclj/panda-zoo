...
public class NumberTransferUtils {
    public static final Set<String> chineseNumSet = Sets.newHashSet();
    private static final Logger logger = LoggerFactory.getLogger(NumberTransferUtils.class, "文本识别");
    private static final int[] numLen = {16, 8, 4, 3, 2, 1};//对应下面单位后面多少个零
    private static final String[] dw = {"兆", "亿", "万", "千", "百", "十"}; //中文单位
    private static final String[] dw1 = {"兆", "亿", "萬", "仟", "佰", "拾"}; //中文单位另一版本
    private static final String[] sz = {"零", "一", "二", "三", "四", "五", "六", "七", "八", "九", "十"}; //中文数字
    private static String[] sz1 = {"〇", "壹", "贰", "叁", "肆", "伍", "陆", "柒", "捌", "玖", "拾"}; //中文数字另一版本
    private static final String CHINESE_POINT = "点";
    private static final String SPECIAL_TWO = "两";
    ...
    static {
        chineseNumSet.addAll(Sets.newHashSet(dw));
        chineseNumSet.addAll(Sets.newHashSet(dw1));
        chineseNumSet.addAll(Sets.newHashSet(sz));
        chineseNumSet.addAll(Sets.newHashSet(sz1));
        chineseNumSet.add(CHINESE_POINT);
        chineseNumSet.add(SPECIAL_TWO);
    }
...
//        System.out.println(NumberTransferUtils.ch2Num("十一"));
//        System.out.println(NumberTransferUtils.ch2Num("一百零五"));
//        System.out.println(NumberTransferUtils.ch2Num("两百零五"));
//        System.out.println(NumberTransferUtils.ch2Num("一千零五百"));
//        System.out.println(NumberTransferUtils.ch2Num("一万五千二百三十一"));
//        System.out.println(NumberTransferUtils.ch2Num("十一"));
//        System.out.println(NumberTransferUtils.analyze("六五十一"));
        System.out.println(NumberTransferUtils.analyze("六十一点五二"));
        System.out.println(NumberTransferUtils.analyze("一百零五点二三"));
    }
}